...
Public Class FR_KARYAWAN
    ...
    Sub TAMPIL()
        Dim Str As String = "SELECT NIK,RTRIM(NAMA) AS NAMA, RTRIM (ASAL) AS ASAL, TGL, JK, RTRIM(ALAMAT) AS ALAMAT, RTRIM (NOHP) AS NOHP FROM TBL_KARYAWAN WHERE NAMA LIKE '%" & TXTCARI.Text & "%'"
    ...
    Private Sub BTNSIMPAN_Click(sender As Object, e As EventArgs) Handles BTNSIMPAN.Click
        ...
        Else
            ...
            CMD = New SqlCommand(STR, CONN)
            CMD.ExecuteNonQuery()
            MsgBox("DATA BERHAASIL TERSIMPAN..")
            TXTNIK.Text = AUTONIK()
            TAMPIL()
        End If
    End Sub
    ...
    Private Sub DGTAMPIL_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DGTAMPIL.CellContentClick
        TXTNIK.Text = DGTAMPIL.Item("NIK", e.RowIndex).Value
    End Sub
    ...
    Private Sub BTNHAPUS_Click(sender As Object, e As EventArgs) Handles BTNHAPUS.Click
        If TXTNIK.Text = "" Then
            MsgBox("NIK KOSONG..")
        Else
            If MsgBox("YAKIN DIHAPS..??", vbYesNo) = vbYes Then
    ...
    Private Sub JADIKANUSERADMINToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles JADIKANUSERADMINToolStripMenuItem.Click
        ...
        With FR
            .LBNIK.Text = DGTAMPIL.Item("NIK", DGTAMPIL.CurrentRow.Index).Value
            .LBNAMA.Text = DGTAMPIL.Item("NAMA", DGTAMPIL.CurrentRow.Index).Value
            .ShowDialog()
        End With
    End Sub
End Class